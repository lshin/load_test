"""Simple application load testing script.

This is a simple application load testing
skeleton script. Initially used to load test
Graylog2 by sending GELFMessages
"""
...
def threadproc():
	"""This thread is executed by each thread"""
	...
	while not quitevent.is_set():
		try:
			...
			# !!!!!!!!!!!!!!!
			resp, content = h.request("http://hsoj.org")
			if resp.status != 200:
				print "Response is OK"
		except socket.timeout:
			pass

	print "Threaded finished: %s" % current_thread().getName()
